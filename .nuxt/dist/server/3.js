...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/editor/index.vue?vue&type=template&id=e57d741e&
...
// CONCATENATED MODULE: ./pages/editor/index.vue?vue&type=template&id=e57d741e&
  ...
  methods: {
    ...
    async onPublishArticle() {
      try {
        ...
        const {
          data
        } = this.isEditor ? await Object(api_article["k" /* updateArticle */])(this.$route.params.slug, params) : await Object(api_article["a" /* addArticle */])(params);
        this.$router.push({
          name: 'article',
          params: {
